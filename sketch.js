...
// top
  ...
  block1a= new Block(690, 155, 30, 40);

 block2a= new Block(660, 195, 30, 40);
 block3a= new Block(690, 195, 30, 40);
 block4a= new Block(720, 195, 30, 40);
 
 block5a= new Block(630, 235, 30, 40);
 block6a= new Block(660, 235, 30, 40);
 block7a= new Block(690, 235, 30, 40);
 block8a= new Block(720, 235, 30, 40);
 block9a= new Block(750, 235, 30, 40);
